...
public class EventController {
    ...
    public EventController(EventService eventService, LocationService locationService, SavedBookingService savedBookingService) {
    ...
    public String eventDetailsPage(Model model, @PathVariable Long id) {
        if (this.eventService.findById(id).isPresent()) {
            ...
            model.addAttribute("event", event);
            List<SavedBooking> bookings = this.savedBookingService.findByEvent(eventService.findById(id).get());
    ...
    public String saveBooking(
        ...
        this.savedBookingService.save(eventService.findById(eventId).get(), numTickets);
        return "redirect:/events/events-list";
    }
}
